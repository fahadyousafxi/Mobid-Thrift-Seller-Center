...
class EditProduct extends StatefulWidget {
  ...
  String productUid;
  EditProduct(
      {required this.productUid, required this.productCollectionName, Key? key})
      : super(key: key);
...
class _EditProductState extends State<EditProduct> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: MyAppbar().mySimpleAppBar(context, title: "Edit Product Details"),
      body: Center(
        child: Padding(
                          ...
                          if (_myFormKey.currentState!.validate()) {
                            if (buttonEnable == false) {
                              ...
                              _fireStore
                                ...
                                Utils.flutterToast('Product has been Edited');
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
